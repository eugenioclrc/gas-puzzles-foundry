...
contract EscrowV2 {
    ...
    constructor(address _buyer, address _seller, address _arbiter, uint256 _duration) {}
    ...
    function sellerWithdraw() public {
        ...
        require(block.timestamp >= depositDate + duration, "you cannot withdraw yet, you greedy seller. Take it easy");
